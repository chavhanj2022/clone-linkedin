class WorkExperiencesController < ApplicationController
    ...
    def create
        ...
        respond_to do |format|
            if @work_experience.save
                ...
                format.turbo_stream { render turbo_stream: turbo_stream.replace('remote_modal', partial: 'shared/turbo_model', locals: {form_partial: 'work_experiences/form', modal_title: 'Add new work experience'})}
            end
        end
    end
    ...
    def work_experience_params
        params.require(:work_experience).permit(:start_date, :currently_working_here, :company, :employment_type, :location, :location_type, :description, :user_id, :job_title,:end_date)
    end
end
